...
\definecolor{termBg}{RGB}{15,15,15}
\definecolor{termFg}{RGB}{230,230,230}
\definecolor{termGreen}{RGB}{120,255,120}
\definecolor{termCyan}{RGB}{120,220,255}
\definecolor{termGray}{RGB}{170,170,170}

\lstdefinestyle{ciscoTerminal}{
  backgroundcolor=\color{termBg},
  basicstyle=\ttfamily\small\color{termFg},
  keywordstyle=\color{termCyan}\bfseries,
  commentstyle=\color{termGray},
  stringstyle=\color{termGreen},
  showstringspaces=false,
  columns=fullflexible,
  keepspaces=true,
  frame=single,
  rulecolor=\color{termGray},
  breaklines=true,
  aboveskip=10pt,
  belowskip=10pt,
  morekeywords={enable,conf,t,terminal,hostname,interface,ip,route,show,run,do,end,wr,copy,exit},
}
